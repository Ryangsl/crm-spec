...
- **Atendimento/Conversas**: distribuição só entre consultores/atendentes ativos e disponíveis (BR-14 — pendente de [D-071](../00-governance/decision-register.md#d-071--disponibilidade-de-consultoratendente-para-distribuição-automática)), obrigatoriedade de disposição ao encerrar (BR-15 — sujeita às pendências de [D-070](../00-governance/decision-register.md#d-070--definição-de-produto-crm-comercial--atendimentoconversas--whatsapp-sem-call-center-telefônico)).
